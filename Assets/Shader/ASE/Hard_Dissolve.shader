...
Shader "Hard_Dissolve"
{
	Properties
	{
		...
		_Float0("Float 0", Range( 0 , 1.05)) = 0
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float4 appendResult11 = (float4((tex2DNode8).rgba.rgb , 0.0));
				
				float2 uv_DissolveTex = packedInput.ase_texcoord2.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
				
				surfaceDescription.Color = appendResult11.xyz;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( tex2DNode8.a * step( _Float0 , tex2D( _DissolveTex, uv_DissolveTex ).r ) );
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode8 = tex2D( _MainTex, uv_MainTex );
				float2 uv_DissolveTex = packedInput.ase_texcoord.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
...
/*ASEBEGIN
Version=19800
Node;AmplifyShaderEditor.RangedFloatNode;14;-1360,32;Inherit;False;Property;_Float0;Float 0;2;0;Create;True;0;0;0;False;0;False;0;0.04;0;1.05;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;9;-1360,128;Inherit;True;Property;_DissolveTex;DissolveTex;1;0;Create;True;0;0;0;False;0;False;-1;f50d85e6ebbe4674583999972107bc92;f50d85e6ebbe4674583999972107bc92;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;8;-1088,-320;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;d124073fd99a7fa4e907acf5fc04aa16;d124073fd99a7fa4e907acf5fc04aa16;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StepOpNode;13;-1024,32;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;10;-656,-320;Inherit;True;True;True;True;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-640,32;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;11;-320,-224;Inherit;True;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=D20B184C6FA9CEF31726929985985C8D14A49D8B