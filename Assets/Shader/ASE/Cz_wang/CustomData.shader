	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult25 = (float2(texCoord12.x , texCoord12.y));
				float2 uv_NoiseTex = packedInput.ase_texcoord2.xy * _NoiseTex_ST.xy + _NoiseTex_ST.zw;
				float2 temp_cast_0 = (tex2D( _NoiseTex, uv_NoiseTex ).r).xx;
				float2 lerpResult15 = lerp( ( uv_MainTex + appendResult25 ) , temp_cast_0 , texCoord12.z);
				float4 tex2DNode8 = tex2D( _MainTex, lerpResult15 );
				
				float2 uv_DissolveTex = packedInput.ase_texcoord2.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
				
				surfaceDescription.Color = (tex2DNode8).rgba.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( tex2DNode8.a * step( texCoord12.w , tex2D( _DissolveTex, uv_DissolveTex ).r ) );
		...
		Pass
		{
					...
					)
			{
				...
				float4 texCoord12 = packedInput.ase_texcoord4;
				texCoord12.xy = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult25 = (float2(texCoord12.x , texCoord12.y));
				float2 uv_NoiseTex = packedInput.ase_texcoord3.xy * _NoiseTex_ST.xy + _NoiseTex_ST.zw;
				float2 temp_cast_0 = (tex2D( _NoiseTex, uv_NoiseTex ).r).xx;
				float2 lerpResult15 = lerp( ( uv_MainTex + appendResult25 ) , temp_cast_0 , texCoord12.z);
				float4 tex2DNode8 = tex2D( _MainTex, lerpResult15 );
				float2 uv_DissolveTex = packedInput.ase_texcoord3.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
...
/*ASEBEGIN
Version=19800
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-1952,144;Inherit;True;2;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-1504,432;Inherit;True;0;16;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-1504,-368;Inherit;True;0;8;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;25;-1482.614,91.09927;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;16;-1216,416;Inherit;True;Property;_NoiseTex;NoiseTex;1;0;Create;True;0;0;0;False;0;False;-1;f50d85e6ebbe4674583999972107bc92;f50d85e6ebbe4674583999972107bc92;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-1111.514,-12.01254;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;15;-864,160;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;21;-512,608;Inherit;True;Property;_DissolveTex;DissolveTex;2;0;Create;True;0;0;0;False;0;False;-1;f50d85e6ebbe4674583999972107bc92;f50d85e6ebbe4674583999972107bc92;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;8;-576,144;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;d124073fd99a7fa4e907acf5fc04aa16;d124073fd99a7fa4e907acf5fc04aa16;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StepOpNode;20;-160,464;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;128,448;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;18;-48,144;Inherit;True;True;True;True;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;22;0;8;4
WireConnection;22;1;20;0
WireConnection;18;0;8;0
WireConnection;0;0;18;0
WireConnection;0;2;22;0
ASEEND*/
//CHKSM=1F80095EBA48A8054B89544E1D0F918C448A5243