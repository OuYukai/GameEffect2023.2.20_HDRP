...
Shader "Soft_Dissolve_Fuction"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		_Progress("Progress", Range( 0 , 1)) = 0
		_Hard_Soft("Hard_Soft", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode2_g3 = tex2D( _MainTex, uv_MainTex );
				
				float temp_output_14_0_g3 = (0.51 + (_Hard_Soft - 0.0) * (1.0 - 0.51) / (1.0 - 0.0));
				float2 uv_NoiseTex = packedInput.ase_texcoord2.xy * _NoiseTex_ST.xy + _NoiseTex_ST.zw;
				float smoothstepResult10_g3 = smoothstep( ( 1.0 - temp_output_14_0_g3 ) , temp_output_14_0_g3 , ( tex2D( _NoiseTex, uv_NoiseTex ).r + 1.0 + ( (0.0 + (_Progress - 0.0) * (1.05 - 0.0) / (1.0 - 0.0)) * -2.0 ) ));
				
				surfaceDescription.Color = (tex2DNode2_g3).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( tex2DNode2_g3.a * smoothstepResult10_g3 );
...
/*ASEBEGIN
Version=19800
Node;AmplifyShaderEditor.RangedFloatNode;10;-1008,0;Inherit;False;Property;_Progress;Progress;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-1008,80;Inherit;False;Property;_Hard_Soft;Hard_Soft;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;14;-944,176;Inherit;True;Property;_MainTex;MainTex;2;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;15;-944,384;Inherit;True;Property;_NoiseTex;NoiseTex;3;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;17;-528,0;Inherit;False;SoftDissolve;-1;;3;f0075ab1701e5cb4896b710a4711c780;0;4;20;FLOAT;0;False;21;FLOAT;0;False;1;SAMPLER2D;;False;19;SAMPLER2D;;False;2;FLOAT3;0;FLOAT;22
