...
Shader "FlowMap_Dissolve"
{
	Properties
	{
		...
		_MaskPower("MaskPower", Range( 0 , 10)) = 10
		_MaskMul("MaskMul", Range( 0 , 5)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				o.ase_texcoord3.xyz = inputMesh.ase_texcoord1.xyz;
					...
					)
			{
				...
				float4 tex2DNode15 = tex2D( _FlowMap, uv_FlowMap );
				float4 appendResult16 = (float4(tex2DNode15.r , tex2DNode15.g , 0.0 , 0.0));
				float3 texCoord28 = packedInput.ase_texcoord3.xyz;
				texCoord28.xy = packedInput.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult29 = lerp( _Progress , texCoord28.z , _UseDissOrCD);
				float4 lerpResult13 = lerp( float4( uv_MainTex, 0.0 , 0.0 ) , appendResult16 , lerpResult29);
				float4 tex2DNode8 = tex2D( _MainTex, lerpResult13.xy );
				
				float smoothstepResult24 = smoothstep( ( 1.0 - _SoftDissolve ) , _SoftDissolve , ( tex2D( _DissolveTex, lerpResult13.xy ).r + 1.0 + ( lerpResult29 * -2.0 ) ));
				float2 texCoord30 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				
				surfaceDescription.Color = ( tex2DNode8 * packedInput.ase_color ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( tex2DNode8.a * packedInput.ase_color.a * smoothstepResult24 * saturate( ( ( ( 1.0 - distance( texCoord30 , float2( 0.5,0.5 ) ) ) - _MaskPower ) * _MaskMul ) ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				o.ase_texcoord3.xyz = inputMesh.uv1.xyz;
				o.ase_color = inputMesh.ase_color;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				o.ase_texcoord1.xyz = inputMesh.ase_texcoord1.xyz;
				o.ase_color = inputMesh.ase_color;
					...
					)
			{
				...
				float2 uv_FlowMap = packedInput.ase_texcoord.xy * _FlowMap_ST.xy + _FlowMap_ST.zw;
				float4 tex2DNode15 = tex2D( _FlowMap, uv_FlowMap );
				float4 appendResult16 = (float4(tex2DNode15.r , tex2DNode15.g , 0.0 , 0.0));
				float3 texCoord28 = packedInput.ase_texcoord1.xyz;
				texCoord28.xy = packedInput.ase_texcoord1.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult29 = lerp( _Progress , texCoord28.z , _UseDissOrCD);
				float4 lerpResult13 = lerp( float4( uv_MainTex, 0.0 , 0.0 ) , appendResult16 , lerpResult29);
				float4 tex2DNode8 = tex2D( _MainTex, lerpResult13.xy );
				float smoothstepResult24 = smoothstep( ( 1.0 - _SoftDissolve ) , _SoftDissolve , ( tex2D( _DissolveTex, lerpResult13.xy ).r + 1.0 + ( lerpResult29 * -2.0 ) ));
		...
		Pass
		{
			...
			VertexInput ApplyMeshModification(VertexInput inputMesh, float3 timeParameters, inout VertexOutput o )
			{
				...
				o.ase_texcoord4.xyz = inputMesh.ase_texcoord1.xyz;
				o.ase_color = inputMesh.ase_color;
					...
					)
			{
				...
				float4 tex2DNode15 = tex2D( _FlowMap, uv_FlowMap );
				float4 appendResult16 = (float4(tex2DNode15.r , tex2DNode15.g , 0.0 , 0.0));
				float3 texCoord28 = packedInput.ase_texcoord4.xyz;
				texCoord28.xy = packedInput.ase_texcoord4.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult29 = lerp( _Progress , texCoord28.z , _UseDissOrCD);
				float4 lerpResult13 = lerp( float4( uv_MainTex, 0.0 , 0.0 ) , appendResult16 , lerpResult29);
				float4 tex2DNode8 = tex2D( _MainTex, lerpResult13.xy );
				float smoothstepResult24 = smoothstep( ( 1.0 - _SoftDissolve ) , _SoftDissolve , ( tex2D( _DissolveTex, lerpResult13.xy ).r + 1.0 + ( lerpResult29 * -2.0 ) ));
...
/*ASEBEGIN
Version=19800
Node;AmplifyShaderEditor.SamplerNode;15;-1936,-80;Inherit;True;Property;_FlowMap;FlowMap;1;0;Create;True;0;0;0;False;0;False;-1;b97c14dbf2a7fa140940fe6cbe1417fc;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;23;-1856,400;Inherit;False;Property;_Progress;Progress;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;28;-1824,496;Inherit;False;1;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-1760,656;Inherit;False;Property;_UseDissOrCD;UseDissOrCD;5;1;[Enum];Create;True;0;2;On;0;Off;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;30;-1760,1008;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;32;-1696,1344;Inherit;False;Constant;_Vector0;Vector 0;6;0;Create;True;0;0;0;False;0;False;0.5,0.5;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-1632,-176;Inherit;False;0;8;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;16;-1600,-32;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.LerpOp;29;-1504,480;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;31;-1392,1168;Inherit;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;13;-1264,-48;Inherit;True;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-1031.174,752.7276;Inherit;False;Constant;_Float2;Float 2;4;0;Create;True;0;0;0;False;0;False;-2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;33;-1088,1168;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-1184,1456;Inherit;False;Property;_MaskPower;MaskPower;6;0;Create;True;0;0;0;False;0;False;10;10;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;18;-960,400;Inherit;True;Property;_DissolveTex;Dissolve Tex;2;0;Create;True;0;0;0;False;0;False;-1;ef703ab53829f524eb8da6550f01624e;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;20;-832,608;Inherit;False;Constant;_Float1;Float 1;4;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-832,704;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-608,848;Inherit;False;Property;_SoftDissolve;SoftDissolve;3;0;Create;True;0;0;0;False;0;False;1;0;0.51;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-672,1456;Inherit;False;Property;_MaskMul;MaskMul;7;0;Create;True;0;0;0;False;0;False;1;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;40;-768,1184;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-528,448;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;26;-464,704;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-416,1200;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-960,-80;Inherit;True;Property;_MainTex;Main Tex;0;0;Create;True;0;0;0;False;0;False;-1;66023062830d25741b194ef7a0f089c1;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.VertexColorNode;9;-864,160;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;24;-128,448;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;39;-112,1200;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-384,-80;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;240,176;Inherit;True;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;608,-64;Float;False;True;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;13;FlowMap_Dissolve;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;True;3;1;False;;10;False;;0;1;False;;0;False;;False;False;True;1;1;False;;0;True;_DstBlend2;0;1;False;;0;False;;False;False;True;1;1;False;;0;True;_DstBlend2;0;1;False;;0;False;;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;1;638764932084945516;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;0;638764932200583481;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Receive Decals;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;0;638764932235730709;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;False;True;True;True;True;False;True;False;;False;0
...
ASEEND*/
//CHKSM=4DE2CD44951E6A1F3FDCBE6DE326828F2613BD0B