	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float4 tex2DNode11 = tex2Dlod( _NoiseTex, float4( panner12, 0, 0.0) );
				float3 appendResult18 = (float3(0.0 , ( tex2DNode11.r * _OffsetIntensity ) , 0.0));
...
Node;AmplifyShaderEditor.TFHCRemapNode;15;-1136,192;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-0.5;False;4;FLOAT;0.5;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=FBACBCF4D69EA391475BC080ECEFCA799FCA8E54