	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float3 hsvTorgb9 = RGBToHSV( _Color0.rgb );
				float mulTime13 = _TimeParameters.x * _Float0;
				float3 hsvTorgb10 = HSVToRGB( float3(( hsvTorgb9.x + mulTime13 ),hsvTorgb9.y,hsvTorgb9.z) );
...
/*ASEBEGIN
Version=19800
Node;AmplifyShaderEditor.SimpleAddOpNode;11;-512,80;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RGBToHSVNode;9;-816,64;Inherit;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ColorNode;8;-1104,64;Inherit;False;Property;_Color0;Color 0;0;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.HSVToRGBNode;10;-336,80;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;12;-1072,320;Inherit;False;Property;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;13;-752,320;Inherit;True;1;0;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=6E6CA68F0BAA27584DD91E086B9C6AB3D2A9E0C0